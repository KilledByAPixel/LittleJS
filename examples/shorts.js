...
[
    ...
    new ExampleInfo('3D Collision', 'render3dCollision.js', 'Solid objects bouncing off a box, the cylinder helper and mouse picking', false, '3d, collision, solid, sphere, box, cylinder, raycast, picking, webgl'),
    new ExampleInfo('3D Lights', 'render3dLights.js', 'Three colored point lights circling a scene, plus a directional fill', false, '3d, light, point light, directional, color, webgl'),
    ...
    new ExampleInfo('3D Trails', 'render3dTrails.js', 'Trail3D ribbons behind moving objects and a mesh deformed every frame', false, '3d, trail, ribbon, dynamic, mesh, deform, flag, webgl'),
    new ExampleInfo('3D Drawing', 'render3dDraw.js', 'Immediate mode: boxes, spheres, a mesh, lines, sprites and a ribbon drawn fresh each frame', false, '3d, immediate, draw, box, sphere, line, billboard, ribbon, glow, shadow, webgl'),
    ...
    new ExampleInfo('3D Textures', 'render3dTextures.js', 'A repeating brick floor, wrapped shapes and the mipmap toggle', false, '3d, texture, tile, uv, repeat, wrap, mipmap, webgl'),
