...
[
    ...
    new ExampleInfo('Render 3D Shapes', 'render3dShapes.js', 'Shape builders, lighting, fog, sky and the shading toggle', false, '3d, mesh, lathe, box, sphere, loft, camera, fog, sky, webgl'),
    new ExampleInfo('Render 3D Billboards', 'render3dBillboards.js', 'Textured billboards with alpha, glows, shadows and lines', false, '3d, billboard, sprite, glow, shadow, additive, webgl'),
    new ExampleInfo('Render 3D Height Map', 'render3dHeightMap.js', 'Terrain from a height map image with a color image', false, '3d, terrain, heightmap, image, mesh, webgl'),
    new ExampleInfo('Render 3D Collision', 'render3dCollision.js', 'Sphere, box and cylinder collision helpers with mouse picking', false, '3d, collision, sphere, box, cylinder, raycast, picking, webgl'),
