...
[
    ...
    new ExampleInfo('Path Finder', 'pathFinder.js', 'A* pathfinding plugin with smoothing and debug visualization', false, 'ai, navigation, astar, search'),
    ...
    new ExampleInfo('UI Layout', 'uiLayout.js', 'Auto-arranging container for vertical, horizontal, and grid menus', false, 'grid, menu, layout'),
    ...
    new ExampleInfo('Light System', 'lightSystem.js', 'Additive 2D lighting overlay with soft falloff lights', false, 'webgl, visual, lighting, additive, color, glow'),
    ...
    new ExampleInfo('3D FPS Game', 'raycastingGame.js', 'Pseudo 3D raycasting demo', false, 'FPS, maze, camera'),
    new ExampleInfo('3D Ball Track Game', 'ballTrackGame.js', 'Pseudo 3D ball jumping game', false, 'procedural, camera, projection'),
    ...
    new ExampleInfo('Tween System Plugin Demo', 'tweenSystem', 'Tween plugin demo with easing, looping, and ping-pong', true, 'animation, easing'),
    new ExampleInfo('3D Plugin', '3d', 'Full 3D demo: island, shadows, lights, particles and bloom', true, 'terrain, heightmap, shadows, lights'),
    new ExampleInfo('Three.js 3D Demo', 'threejs', '3D platformer game with LittleJS logic and Three.js rendering', true, 'camera, mesh, physics'),
];
