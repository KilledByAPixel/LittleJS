...
[
    ...
    new ExampleInfo('Speak', 'speak.js', 'Text-to-speech with language, pitch, rate', false, 'audio, voice, tts, ui'),
    ...
    new ExampleInfo('3D Shapes', 'render3dShapes.js', 'Shape builders, lit and shadowed', false, 'mesh, sphere, lathe, shading, specular'),
    new ExampleInfo('3D Billboards', 'render3dBillboards.js', 'Sprites that face the camera', false, 'billboard, sprite, soft shadow'),
    new ExampleInfo('3D Height Map', 'render3dHeightMap.js', 'Terrain from a height map image', false, 'terrain, heightmap, raycast'),
    ...
    new ExampleInfo('3D Lights', 'render3dLights.js', 'Colored point lights and a fill', false, 'light, point light, directional'),
    new ExampleInfo('3D Particles', 'render3dParticles.js', 'Fire, smoke, sparks and a fountain', false, 'particles, emitter, additive'),
    new ExampleInfo('3D Trails', 'render3dTrails.js', 'Trails behind moving objects', false, 'trail, ribbon, flag, deform'),
    ...
    new ExampleInfo('3D Layers', 'render3dLayers.js', '3D in front of and behind 2D', false, 'layers, align2D, renderAfter2D'),
    new ExampleInfo('3D Dodge Game', 'render3dDodgeGame.js', 'Dodge the tumbling boxes', false, 'chase camera, shadows, sound'),
    new ExampleInfo('3D Racer Game', 'render3dRacerGame.js', 'Race laps around a hilly track', false, 'racer, terrain, chase camera'),
    new ExampleInfo('3D Puzzle Game', 'render3dPuzzleGame.js', 'Push the blocks onto the pads', false, 'puzzle, orthographic, picking'),
    new ExampleInfo('3D Mesh', 'render3dMesh.js', 'Load an OBJ model, or drop one in', false, 'obj, model, load'),
    new ExampleInfo('3D Textures', 'render3dTextures.js', 'Repeating and mipmapped textures', false, 'texture, uv, wrap, mipmap'),
    new ExampleInfo('3D Glow', 'render3dGlow.js', 'Bloom over a 3D scene', false, 'bloom, post processing'),
    ...
    new ExampleInfo('3D Plugin', '3d', 'Full 3D demo: island, shadows, lights, particles and bloom', true, '3d, terrain, heightmap, shadows, lights, particles, bloom, webgl'),
    ...
    new ExampleInfo('Three.js 3D Platformer', 'threejs/platformer', '3D platformer game with LittleJS logic and Three.js rendering', true, '3d, jump, coins, camera, mesh, webgl'),
];
