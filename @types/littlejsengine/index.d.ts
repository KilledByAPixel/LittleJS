...
declare let debugParticleEditor: number;
declare let debugParticleSystem: any;
declare let debugParticleSystemDiv: any;
declare let particleSystemCode: any;
declare function debugToggleParticleEditor(): void;
declare const debugParticleSettings: string[][];
 ...
 *  @return {Number}
 *  @memberof Utilities */
declare function clamp(v: any, max?: number, min?: number): number;
 ...
 *  @return {Number}
 *  @memberof Utilities */
declare function percent(v: any, max?: number, min?: number): number;
 ...
 *  @return {Number}
 *  @memberof Utilities */
declare function lerp(p: any, max?: number, min?: number): number;
...
/** Version of engine */
declare const engineVersion: "1.1.27";
...
declare const canvaStyle: "position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)";
